...
console.log(quick_draw_data_set.random[random_number]);
...
function setup() {
    ...
    console.log("mouse has been releaseed and canvas has been classfies")
...
function preload() {
    ...
    console.log("the classifer has been activated.")
}

function draw() {
    strokeWeight(13);
    stroke(0);
    console.log("stroke weight is 13 and stroke is 0");
    if(mouseIsPressed)
    {
...
function check_sketch() {
    ...
    console.log("sketch has been checked");
    ...
    if(timer_check=="completed"||answer_holder=="set") {
        timer_check= "";
        answer_holder="";
        console.log("timer check and answer hold = blank + timer check = completed or answerholder = set");
        updateCanvas();
